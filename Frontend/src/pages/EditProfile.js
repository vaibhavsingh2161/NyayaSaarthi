...
const EditProfile = () => {
    ...
    const fetchProfile = async () => {
      try {
        ...
        if (profileData.workExperience) {
          profileData.workExperience = profileData.workExperience.map(exp => ({
            ...exp,
  ...
  const handleAddEducation = () => {
    if (!newEducation.degree || !newEducation.university || !newEducation.yearOfPassing) return;
  ...
  if (loading) {
    return <div className="edit-profile-container"><p>Loading profile data...</p></div>;
  }

  if (error) {
    return <div className="edit-profile-container"><p>Error: {error}</p></div>;
  }
    ...
    <div className="edit-profile-container">
      ...
      <form onSubmit={handleSubmit} className="edit-profile-form">
        ...
        <div className="form-section">
          ...
          <div className="tags-container">
            {formData.courts && formData.courts.map((court, index) => (
              <div key={index} className="tag">
                {court}
                <button 
                  type="button" 
        ...
        <div className="form-section">
          ...
          <div className="tags-container">
            {formData.specialisation && formData.specialisation.map((spec, index) => (
              <div key={index} className="tag">
                {spec}
                <button 
                  type="button" 
            ...
            {formData.education && formData.education.map((edu, index) => (
              <div key={index} className="complex-item">
                <div className="complex-item-details">
                  ...
                  <p>{edu.university} | {edu.yearOfPassing}</p>
        ...
        <div className="form-section">
          ...
          <div className="tags-container">
            {formData.casesHandled && formData.casesHandled.map((caseType, index) => (
              <div key={index} className="tag">
                {caseType}
                <button 
                  type="button" 
        ...
        <div className="form-section">
          ...
          <div className="tags-container">
            {formData.clientele && formData.clientele.map((client, index) => (
              <div key={index} className="tag">
                {client}
                <button 
                  type="button" 
